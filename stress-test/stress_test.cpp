...
#define NUM_THREADS 1  //线程
#define TEST_COUNT 100000
SkipList<int, std::string> skipList(18); //跳表18层
...
int main() {
    srand (time(NULL));  
    {
        ...
        pthread_t threads[NUM_THREADS]; //NUM_THREADS个线程
        int rc;
        int i;
        ...
        std::chrono::duration<double> elapsed = finish - start;//所用时间
